            ...
            <div class="container">
                <form class="form-horizontal" action="islem.php" method="post">
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="email">Site Adresi:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ayar_siteurl" value="<?php echo $ayarcek["ayar_siteurl"];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="email">Site Başlığı:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ayar_title" value="<?php echo $ayarcek["ayar_title"];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="email">Site Açıklaması:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ayar_description" value="<?php echo $ayarcek["ayar_description"];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="email">Site Anahtar Kelimeler:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ayar_keyword" value="<?php echo $ayarcek["ayar_keyword"];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="email">Site Yazar:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ayar_author" value="<?php echo $ayarcek["ayar_author"];?>">
                        </div>
                    </div>
