...
$iceriksor =$dbh->prepare("select * from blog where id=:blog_id");
            ...
            <div class="container">
                <form class="form-horizontal" action="islem.php" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="user_id" value="<?php echo $icerikcek["user_id"];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="email">Blog Başlık:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="title" value="<?php echo $icerikcek["title"];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="email">	Blog İçerik:</label>
                        <div class="col-sm-10">
                            <textarea class="ckediyor" id="body" name="body"><?php echo $icerikcek["body"];?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-2" for="email">	Blog Güncelleme Tarihi:</label>
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name="updated_at" value="<?php echo $icerikcek["updated_at"];?>">
                        </div>
                    </div>
                    <input type="hidden" name="blog_id" value="<?php echo $icerikcek["id"]?>" />
