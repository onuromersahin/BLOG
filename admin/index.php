...
$kullanici = DB::getRow("SELECT * FROM members WHERE id=?",array( $kullanici_id ));
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-5">Admin Paneline Hoş Geldiniz</h1><hr>
                <div class="alert alert-secondary" role="alert">
                    <h5>Sitenizi yönetmek için sol taraftaki menüyü kullanabilirisiniz.</h5>
                </div>
            </div>
            <table class="table table-bordered mt-4" id="dataTable" width="100%" cellspacing="0">
                <thead class="thead-dark">
                <tr>
                    <th scope="col" class="text-center" width="98px">Blog ID</th>
                    <th scope="col" class="text-center" width="90px">Blog Başlık</th>
                    <th scope="col" class="text-center">Blog İçerik</th>
                    <th scope="col" class="text-center" width="90px">Blog Tarih</th>
                    <th scope="col" class="text-center" width="90px">Blog Yazar</th>
                </tr>
                </thead>
                <tbody>
                ...
                <?php foreach ($icerikcek as $blog): ?>
                    <tr>
                        ...
                        <td class="text-center">İçeriğe ulaşmak için <a href="icerikduzenle.php?blog_id=<?php echo $blog["id"];?>"><b class="text-dark">tıklayınız.</b></a></td>
