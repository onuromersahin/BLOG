    ...
    <div class="row mt-5">
        ...
        <div class="col-md-4">
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <p class="fs-5"><a class="text-decoration-none text-#3B5998" href="<?php echo $ayarcek["ayar_facebook"];?>" target="_blank"><i class="bi bi-facebook"></i> | Facebook</a></p>
                    <p class="fs-5"><a class="text-decoration-none text-info" href="<?php echo $ayarcek["ayar_twitter"];?>" target="_blank"><i class="bi bi-twitter"></i> | Twitter</a></p>
                    <p class="fs-5"><a class="text-decoration-none text-danger" href="<?php echo $ayarcek["ayar_youtube"];?>" target="_blank"><i class="bi bi-youtube"></i> | Youtube</a></p>
                    <p class="fs-5"><a class="text-decoration-none text-#007BB6" href="<?php echo $ayarcek["ayar_linkedin"];?>" target="_blank"><i class="bi bi-linkedin"></i> | Linkedin</a></p>
                    <p class="fs-5"><a class="text-decoration-none text-#3f729b" href="<?php echo $ayarcek["ayar_instagram"];?>" target="_blank"><i class="bi bi-instagram"></i> | İnstagram</a></p>
                </div>
            </div>
...
<footer class="py-4 bg-dark">
    <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; <?php echo $ayarcek["ayar_author"];?> 2021</p>
    </div>
    <!-- /.container -->
</footer>
